...
<div class="form-group">
    ...
    <input class="form-control" type="number" id="cantidad" name="cantidad" required><br>
    </div>
    <div class="form-group">
    <label for="precio">Precio:</label>
    <input class="form-control" type="number" step="0.01" id="precio" name="precio" required><br>

    </div>
    <div class="form-group">
    <label for="idCategoria">ID de Categoría:</label>
    <select class="form-control"  id="idCategoria" name="idCategoria" required><br>
    <?php
         // Recorre los resultados de la consulta y muestra los productos
    ...
    <input class="form-control" type="text" id="imagen" name="imagen" required><br>

    </div>
    <div class="form-group">
    <label for="informacion">Información:</label>
    <textarea  class="form-control" id="informacion" name="informacion" required></textarea><br>
