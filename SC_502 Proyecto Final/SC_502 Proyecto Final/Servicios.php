...
<?php
$conexion = ConnectDB();
// Consulta SQL para obtener los productos de la categoría "Servicios" y sus imágenes
$sql = "SELECT * FROM producto WHERE idCategoria = 4"; // "Servicios" tiene idCategoria = 4
// Ejecuta la consulta
...
<div class="section">
    <div class="container">
        <div class="row">
            ...
            while ($producto = mysqli_fetch_assoc($resultado2)) {
                ?>
                <!-- PRODUCTO -->
